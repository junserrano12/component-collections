...
var css = ".Lists_container__3GEo1 {\n  display: block;\n  position: relative;\n  margin: 0;\n  padding: 0; }\n  .Lists_container__3GEo1[class*=\"bullet\"] {\n    list-style: disc outside;\n    margin-left: 24px; }\n  .Lists_container__3GEo1[class*=\"default\"] {\n    list-style: none; }\n\n.Lists_content__3yn1Y {\n  position: relative; }\n";
var style = { "container": "Lists_container__3GEo1", "content": "Lists_content__3yn1Y" };
styleInject(css);

var renderChildren = function renderChildren(children) {
    return React.Children.map(children, function (child) {
        if (child.type === List) return child;else return null;
    });
};
...
var List = function List(_ref) {
    ...
    classes.map(function (classNames) {
...
var Lists = function Lists(_ref2) {
    ...
    var containerStyle = style.container + ' ' + type;
...
var customStyleActions = {
    ...
    CUSTOM_LISTS_STYLE: function CUSTOM_LISTS_STYLE(state, payload) {
        return _extends({}, state, {
            customStyle: _extends({}, state.customStyle, {
                lists: payload.style
            })
...
var css$1 = ".Modal_wrapper__3oG8l {\n  position: fixed;\n  top: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.8);\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-flow: row wrap;\n  justify-content: center;\n  align-items: center; }\n\n.Modal_container__3vtwr {\n  background: white;\n  max-width: 623px;\n  width: 80%;\n  height: 80%;\n  border-radius: 4px;\n  overflow: hidden; }\n\n.Modal_header__3jVSR {\n  background: #ddd;\n  padding: 16px 24px;\n  display: block;\n  position: relative; }\n  .Modal_header__3jVSR ~ [class*=\"content\"] {\n    height: calc(100% - 56px); }\n\n.Modal_content__1LnVv {\n  display: block;\n  position: relative;\n  padding: 32px 24px;\n  overflow-y: auto;\n  height: 100%; }\n  .Modal_content__1LnVv > *:last-child() {\n    padding-bottom: 0;\n    margin-bottom: 0; }\n";
var style$1 = { "wrapper": "Modal_wrapper__3oG8l", "container": "Modal_container__3vtwr", "header": "Modal_header__3jVSR", "content": "Modal_content__1LnVv" };
styleInject(css$1);
...
var Modal = function Modal(_ref) {
    ...
    var modalStyle = componentStyle.modal !== null ? componentStyle.modal : style$1;
...
export { Lists, List, Modal, useModal, useCustomStyle };
